  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        title: 'Infidelity',
        tags: ['Faithfulness'],
        summary: 'The mean squared difference between the score change predicted by the attribution and the change observed under random perturbations.',
        differs: 'It tests whether the attribution predicts the model\'s response to a perturbation. A score of zero would indicate a perfect local prediction.',
        facts: [
          ['Measures', 'Explanation error'],
          ['Better', 'Lower'],
          ['Removes', 'Nothing — it perturbs at random'],
          ['Limit', 'The result depends on the perturbations sampled'],
        ],
        links: [
